...
#criando variavel todos os valores
todos_valores = ''
...
b_17 = Button(frame_corpo, command=calcular, text=".", width=5, height=2 , bg=cor4, font=('Ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
